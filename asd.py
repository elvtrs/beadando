...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            try:
                szobaszam_choices = list(hotel.szobak.keys())
                szobaszam = simpledialog.askstring("Foglalások listázása", "Válassza ki a szobaszámot:", initialvalue=szobaszam_choices[0], parent=tk.Tk())
                if szobaszam:
                    print(hotel.listaz())
            except ValueError as e:
                print(f"Hiba: {e}")
